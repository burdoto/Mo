...
/**
 * The basic command de.btobastian.sdcf4j.handler.
 */
public abstract class CommandHandler {
     ...
     */
    public void registerCommand(de.btobastian.sdcf4j.CommandExecutor executor) {
        for (Method method : executor.getClass().getMethods()) {
            de.btobastian.sdcf4j.Command annotation = method.getAnnotation(de.btobastian.sdcf4j.Command.class);
            if (annotation == null) {
                continue;
            }
    ...
    public class SimpleCommand {
        ...
        private final de.btobastian.sdcf4j.Command annotation;
        private final Method method;
        private final de.btobastian.sdcf4j.CommandExecutor executor;
         ...
         */
        protected SimpleCommand(de.btobastian.sdcf4j.Command annotation, Method method, de.btobastian.sdcf4j.CommandExecutor executor) {
